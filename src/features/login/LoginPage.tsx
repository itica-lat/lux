...
export function LoginPage() {
 ...
 <p className="text-sm text-muted-foreground mt-1">ITI CETP — Sistema de Gestión de Recursos</p>
 </div>
 ...
 <Input
 id="dni" type="text" inputMode="numeric" placeholder="Ej: 12345678" value={dni}
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground dark:hover:text-white transition-colors" tabIndex={-1}
 ...
 <div
 className="h-full bg-[rgb(255,159,10)] rounded-full transition-all" style={{ width: `${Math.min(attempts * 20, 100)}%` }}
 />
 </div>
 ...
 <Button
 type="submit" className="w-full" size="lg" disabled={isLoading}
 >
 {isLoading ? (
 <motion.div
 animate={{ rotate: 360 }}
