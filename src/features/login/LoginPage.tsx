    ...
    <div className="min-h-screen flex items-center justify-center bg-app-light dark:bg-app-dark p-4">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[rgb(0,122,255)] shadow-[0_16px_32px_rgba(0,122,255,0.25)] mb-5">
            <Zap className="h-8 w-8 text-white" />
          </div>
          <h1 className="text-2xl font-semibold tracking-[-0.02em] text-[#1d1d1f] dark:text-white">
            Iniciá sesión
          </h1>
          <p className="text-sm text-[#86868b] mt-1">ITI CETP — Sistema de Gestión de Recursos</p>
        </div>

        <div className="rounded-2xl border border-black/8 bg-white/40 p-6 shadow-[0_8px_32px_0_rgba(0,0,0,0.06)] backdrop-blur-xl dark:bg-[#0a0a0c]/40 dark:border-white/5">
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="flex items-start gap-2 rounded-xl bg-[rgba(255,69,58,0.08)] border border-[rgba(255,69,58,0.2)] px-3 py-2.5"
              >
                <AlertCircle className="h-4 w-4 text-[rgb(255,69,58)] mt-0.5 shrink-0" />
                <p className="text-xs text-[rgb(255,69,58)]">{error}</p>
              </motion.div>
            )}
            ...
            {attempts >= 3 && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="rounded-xl bg-[rgba(255,159,10,0.08)] border border-[rgba(255,159,10,0.2)] px-3 py-2 flex items-center gap-2"
              >
                ...
                <span className="text-xs text-[rgb(255,159,10)] whitespace-nowrap">{attempts} intentos</span>
              </motion.div>
            )}
