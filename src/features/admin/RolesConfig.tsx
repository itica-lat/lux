...
export function RolesConfig() {
 ...
 <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-widest text-muted-foreground">Permiso</th>
 {ROLES.map(r => (
 <th key={r} className="px-4 py-3 text-center text-xs font-medium uppercase tracking-widest text-muted-foreground">
 {ROLE_LABELS[r]}
 </th>
 ))}
 </tr>
