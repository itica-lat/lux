...
export function AdminDashboard() {
 ...
 <p className="text-sm text-muted-foreground mt-0.5">Configuración y supervisión del sistema</p>
 </div>
 ...
 <div
 className="inline-flex h-10 w-10 items-center justify-center rounded-xl mb-4" style={{ backgroundColor: `${color}15` }}
 >
