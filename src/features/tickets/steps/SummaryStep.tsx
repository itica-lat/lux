...
export function SummaryStep({
 ...
 <span className="text-xs text-muted-foreground uppercase tracking-widest font-medium">Estado del ticket</span>
 ...
 {ticket.equipment && (
 <div className="flex items-center justify-between">
 <span className="text-xs text-muted-foreground uppercase tracking-widest font-medium">Estado del equipo</span>
 ...
 <div className="flex items-center justify-between">
 <span className="text-xs text-muted-foreground uppercase tracking-widest font-medium">¿Corregido?</span>
 ...
 {diagnosis && (
 <div>
 <span className="text-xs text-muted-foreground uppercase tracking-widest font-medium block mb-1.5">Diagnóstico</span>
 ...
 placeholder="Describí las acciones tomadas para resolver el ticket..." className="h-32" readOnly={readOnly}
 disabled={readOnly}
 />
 </div>
 </div>
