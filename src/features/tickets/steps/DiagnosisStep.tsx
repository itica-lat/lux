...
export function DiagnosisStep({
 ...
 placeholder="Describí el diagnóstico técnico..." className="h-36" readOnly={readOnly}
 disabled={readOnly}
 />
 </div>
 ...
 type="button" onClick={() => !readOnly && onCorrectedChange(opt.value)}
 disabled={readOnly}
 ...
 {ticket.actionsTaken && (
 <div>
 <span className="text-xs text-muted-foreground uppercase tracking-widest font-medium block mb-1.5">Acciones previas tomadas</span>
