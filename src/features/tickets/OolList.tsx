  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-[#1d1d1f] dark:text-white">Tickets sin asignar (OOL)</h1>
          <p className="text-sm text-[#86868b]">Tomá un ticket para comenzar a trabajar</p>
        </div>
      </div>
