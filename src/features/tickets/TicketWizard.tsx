...
export function TicketWizard({ ticket, onComplete, canComplete }: TicketWizardProps) {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 0: return <IncidentStep ticket={ticket} />;
      case 1: return <PcStatusStep ticket={ticket} />;
      case 2: return <PcHistoryStep ticket={ticket} />;
      case 3: return (
        <DiagnosisStep
          ticket={ticket}
          diagnosis={diagnosis}
  ...
  return (
    <div className="flex gap-8 min-h-[500px]">
            ...
            <li key={step.id}>
              <button
                ...
                className={cn(
                  ...
                  currentStep === i
                    ? 'bg-white/60 dark:bg-white/12 text-[#1d1d1f] dark:text-white font-medium shadow-sm'
                    : 'text-[#86868b] hover:bg-black/5 dark:hover:bg-white/8',
                )}
              >
                <span className={cn(
                  ...
                  currentStep === i
                    ...
                    : i < currentStep
                    ? 'bg-[rgba(52,199,89,0.15)] text-[rgb(52,199,89)]'
                    : 'bg-black/8 dark:bg-white/10 text-[#86868b]'
                )}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between pt-6 mt-6 border-t border-black/8 dark:border-white/5">
          <Button
            variant="secondary"
            size="sm"
          ...
          <div className="flex gap-2">
            {currentStep < steps.length - 1 ? (
              ...
              <span className="text-xs text-[rgb(52,199,89)] font-medium flex items-center gap-1">
