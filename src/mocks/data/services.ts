...
export const mockServices: ServiceRequest[] = [
  {
    ...
    equipmentId: null,
    resolutionText:
      "Laboratorio preparado. 12 equipos configurados con Packet Tracer 8.2 y acceso verificado al servidor de prácticas.",
  ...
  },
  {
    ...
    equipmentId: null,
    resolutionText:
      "Solicitud rechazada. El software solicitado requiere licencias comerciales no disponibles en el presupuesto actual. Se recomienda solicitar a través del departamento de recursos.",
  ...
  },
  {
    ...
    equipmentId: "prod-8",
    resolutionText:
      "Impresora configurada en red. Cola de impresión creada en servidor Windows. Todos los equipos de administración pueden imprimir correctamente.",
  ...
  },
  {
    ...
    equipmentId: null,
    resolutionText:
      "JDK 21 y IntelliJ IDEA Community 2024.1 instalados en 10 equipos del laboratorio 2. Variables de entorno configuradas correctamente.",
  ...
  },
  {
    ...
    equipmentId: null,
    resolutionText:
      "Laboratorio reorganizado. 14 equipos revisados y funcionando. 1 equipo enviado a reparación. Software actualizado en todos los equipos operativos.",
